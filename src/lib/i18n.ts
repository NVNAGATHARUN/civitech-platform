...
export const translations = {
    en: {
        ...
        verifier: {
            ...
            select: "Select Income Certificate",
            processing: "Processing...",
            verifying: "Verifying Eligibility...",
            success: "Verified! Income is within limit.",
    ...
    hi: {
        ...
        verifier: {
            ...
            select: "आय प्रमाण पत्र चुनें",
            processing: "प्रसंस्करण...",
            verifying: "पात्रता का सत्यापन...",
            success: "सत्यापित! आय सीमा के भीतर है।",
    ...
    te: {
        ...
        verifier: {
            ...
            select: "ఆదాయ ధృవీకరణ పత్రాన్ని ఎంచుకోండి",
            processing: "ప్రాసెసింగ్...",
            verifying: "అర్హతను ధృవీకరిస్తోంది...",
            success: "ధృవీకరించబడింది! ఆదాయం పరిమితిలో ఉంది.",
